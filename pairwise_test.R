...
std_param_pl <- TrawlPL(data = pollution_data$NO2[1:5000], depth = 5, parametrisation='standard')
...
optim(std_param_pl, par = test_params, method = 'L-BFGS-B', lower=c(0.1, 1, 1, 1e-2), upper=c(0.35, 6, 20, 1), control = list(trace=3))
